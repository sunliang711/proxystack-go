...
install_release_binaries() {
	...
	local version_value="${2:-}"
	local bin_dir="${3:-}"
	local os_name arch_name asset_name display_version download_version temp_dir archive_path checksums_path archive_url checksums_url agent_binary sub_binary
